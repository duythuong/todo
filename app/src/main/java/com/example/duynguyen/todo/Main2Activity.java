...
//            getSupportFragmentManager().beginTransaction().replace(R.id.id_frame,new book()).commit();
    ...
    public void setRecyclerView(){
        ...
        recy custom_list = new recy(doituongs, Main2Activity.this);
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(Main2Activity.this);
